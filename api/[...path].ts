 ...
 * Lives at repo root so deploys with Vercel "Root Directory" = repository root still ship /api/*.
 * Helpers live in frontend/lib/api/* (not under /api, so they are not separate functions).
 */
